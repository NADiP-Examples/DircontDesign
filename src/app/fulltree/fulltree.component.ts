...
import {GeteployeersService} from 'app/shared/services/geteployeers.service'
...
export class FulltreeComponent implements OnInit {
  //nodes: any[];
  nodes2:any[];
  nodes3:[{name: 'root', children:[{name: 'root1'}]}];
  nodes: any[]=[];

  constructor(private getEmployeer: GeteployeersService) {
